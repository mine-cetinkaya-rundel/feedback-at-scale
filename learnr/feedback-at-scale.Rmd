...
# suspend authorization for running non-interactively
gs4_deauth()
...
```{r median-rating-option-1-check-again, eval = FALSE, echo = TRUE}
grade_code()
```
...
```{r median-rating-option-2-check-again, eval = FALSE, echo = TRUE}
grade_code()
```
...
Read data with [`googlesheets4::read_sheet()`](https://googlesheets4.tidyverse.org/reference/range_read.html)
...
- Un-hash answers with [`learnrhash::extract_questions()`](https://rundel.github.io/learnrhash/reference/extract.html) and/or [`learnrhash::extract_exercises()`](https://rundel.github.io/learnrhash/reference/extract.html)
- Check against the key with [`dplyr::left_join()`](https://dplyr.tidyverse.org/reference/mutate-joins.html)
...
Inspect bigrams with [`tidytext::unnest_tokens()`](https://juliasilge.github.io/tidytext/reference/unnest_tokens.html)
...
```{r publish-1, out.width = "100%"}
knitr::include_graphics("images/publish-1.png")
```

###

```{r publish-2, out.width = "70%"}
knitr::include_graphics("images/publish-2.png")
```

###

```{r publish-3, out.width = "100%"}
knitr::include_graphics("images/publish-3.png")
```
